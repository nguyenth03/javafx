...
public class ManagementBooksController implements Initializable {
    ...
    @FXML
    private ComboBox<Author1> boxAuthors;
    @FXML
    ...
    private void BtnSaveClick() {
        ...
        Author1 author = boxAuthors.getValue();
...
//        table();
    ...
    private void table() {
        ...
        colAuthor.setCellValueFactory(f -> {
            Author1 auth = AuthorEntity.GetAuthorWithId(f.getValue().getBook().getAuthorId());
        ...
        table.setRowFactory(tv -> {
            ...
            myRow.setOnMouseClicked(event -> {
                if (event.getClickCount() == 1 && (!myRow.isEmpty())) {
                    ...
                    Author1 auth = AuthorEntity.GetAuthorWithId(table.getItems().get(myIndex).getBook().getAuthorId());
    ...
    private void InitItemsAuthorBox() {
        ObservableList<Author1> authors = AuthorEntity.GetAll();
